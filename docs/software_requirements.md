...
| SRS-ACQ-005 | The simulator shall model the continuous AFE stream option using a circular DMA ring and a 2046-sample extracted window. | `simulator/circular_dma.py` and GUI capture-mode status. |
